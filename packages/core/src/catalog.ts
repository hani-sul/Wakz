...
export const CATEGORIES: CategoryDefinition[] = [
  ...
  },
  {
    ...
    name: 'Shopping',
    nameAr: 'التسوّق',
    description: 'Online stores and commerce platforms',
    descriptionAr: 'المتاجر الإلكترونية ومنصّات التجارة',
    position: 7,
  },
  {
    slug: 'local',
...
export const SERVICES: ServiceDefinition[] = [
  ...
  statuspageService({
    ...
    baseUrl: 'https://www.vimeostatus.com',
    host: 'vimeo.com',
  }),
  {
    slug: 'apple-services',
    ...
    statusPage: 'https://www.apple.com/support/systemstatus/',
    connector: 'apple-status',
    connectorConfig: {
      feedUrl: 'https://www.apple.com/support/systemstatus/data/system_status_en_US.js',
    ...
    confidence: 'high',
    checkTargets: [
      https('https://www.apple.com/', 'Website'),
      https('https://www.apple.com/support/systemstatus/', 'Status page'),
      dns('apple.com'),
      tcp('www.apple.com'),
    ],
    limitation: 'Apple publishes one status feed for all its services (App Store, iCloud, Apple Music, Apple TV+ …); only services with an active event are listed as components.',
    limitationAr: 'تنشر آبل تغذية واحدة لكل خدماتها (App Store وiCloud وApple Music وApple TV+ …)؛ وتُعرض كمكوّنات فقط الخدمات التي لديها حدث نشط.',
  },
  ...
  statuspageService({
    ...
    baseUrl: 'https://www.etsystatus.com',
    host: 'etsy.com',
  }),
  statuspageService({
    slug: 'zalando',
    name: 'Zalando',
    category: 'shopping',
    homepage: 'https://www.zalando.com/',
    baseUrl: 'https://status.zalando.com',
    host: 'zalando.com',
  }),
  statuspageService({
    slug: 'bigcommerce',
    ...
    baseUrl: 'https://status.bigcommerce.com',
  ...
  statuspageService({
    ...
    baseUrl: 'https://status.squarespace.com',
